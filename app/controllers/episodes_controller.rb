class EpisodesController < ApplicationController
  ...
  def update_feed
    ...
    rss.items.each do |result|
      ...
      episode.update(description: result.description, published_date: result.pubDate, url: result.link, audio_url: result.enclosure.url, audio_format: result.enclosure.type)
    end
